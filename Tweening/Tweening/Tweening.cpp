...
void Display() {
    glLineWidth(4.0);
    float StartShape[12][2] = { {-18,-15},{1,-15},{1,-9},{-5,-9},{-5,19},{1,19},{1,25},{-18,25},{-18,19},{-12,19},{-12,-9},{-18,-9} };//huruf i
    float EndShape[12][2] = { {-15,-15},{-5,-15},{5,-15},{5,-35},{15,-35},{15,25},{5,25},{5,-5},{5,-5},{-5,-5},{-5,25},{-15,25} };//angka 4
